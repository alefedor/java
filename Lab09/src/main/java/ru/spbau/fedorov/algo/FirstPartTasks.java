...
import ru.spbau.fedorov.algo.given.Album;
import ru.spbau.fedorov.algo.given.Artist;
import ru.spbau.fedorov.algo.given.Track;
...
public final class FirstPartTasks {
    ...
    public static <R> Stream<R> filterIsInstance(Stream<?> s, Class<R> clazz) {
        return s.filter(clazz::isInstance).map(t -> (R)t);
    }
}